...
contract LendingMarketTest is Test {
    ...
    function setUp() public {
        ...
        lendingMarket =
            new LendingMarket(address(mockUSDC), address(mockMNT), address(rateAdjuster), MOCK_CHAINLINK_FEED);
    ...
    // Helper function to mock Chainlink price with current timestamp
    ...
    function test_Liquidation() public {
        ...
        // Price drops to $0.30 (undercollateralized - 20K MNT * $0.30 = $6K < $12.5K required for 125% threshold)
        // At $0.30: 20K MNT = $6K, debt = $10K + interest, required = debt * 125%, $6K < required
        mockChainlinkPrice(30000000); // $0.30

        // Debug: Check values before liquidation
        LendingMarket.Loan memory loan = lendingMarket.getLoanInfo(user2);
        ...
        console.log("Interest accrued:", loan.interestAccrued);
        ...
        loan = lendingMarket.getLoanInfo(user2);
    ...
    function test_RevertInsufficientCollateral() public {
        ...
        vm.startPrank(user2);
        uint256 borrowAmount = 10000 * 10 ** 6; // 10K USDC
        uint256 collateralAmount = 15000 * 10 ** 18; // 15K MNT (worth $12K at $0.80, 120% collateral ratio, insufficient for 150% requirement)
        // Required collateral: $10K * 150% = $15K, but we only have $12K worth of collateral
